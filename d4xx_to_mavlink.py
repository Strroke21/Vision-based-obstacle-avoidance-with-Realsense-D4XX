...
import numpy as np
import transformations as tf   # auto run blocker 1 # may b i can comment this coz its used for ROS
import math as m
import time
import argparse
import threading
...
from apscheduler.schedulers.background import BackgroundScheduler  #blocker 2
from dronekit import connect, VehicleMode  #blocker 3
from pymavlink import mavutil # blocker 4
from numba import njit    #blocker 5
...
PRESET_FILE  = "/home/pi/vision_to_mavros/cfg/d4xx-default.json"
